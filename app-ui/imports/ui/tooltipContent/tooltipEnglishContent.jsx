export const tooltipEnglishContent = {
    "dce": {
        "accuracyChart": {
            ...
            "featuresConsidered": "Number of predictor variables considered by the prediction model to generate predictions. It is recommeded to train the model on important variables. Noisy and unimportant variables can decrease prediction accuracy.",
